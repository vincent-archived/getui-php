...
class push{
    ...
    public function __construct() {
        ...
        require(PATH . "/lib/getui/GeTui-PHP-Demo/demo" . "IGt.Push.php");
        require(PATH . "/lib/getui/GeTui-PHP-Demo/demo" . "igetui/IGt.AppMessage.php");
        require(PATH . "/lib/getui/GeTui-PHP-Demo/demo" . "igetui/IGt.APNPayload.php");
        require(PATH . "/lib/getui/GeTui-PHP-Demo/demo" . "igetui/template/IGt.BaseTemplate.php");
        require(PATH . "/lib/getui/GeTui-PHP-Demo/demo" . "IGt.Batch.php");
